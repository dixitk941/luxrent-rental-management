        ...
        <div className="lg:col-span-2">
          <div className="card p-6 rounded-xl">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      />
                      <span className="material-symbols-outlined absolute right-3 top-1/2 -translate-y-1/2 text-slate/50" style={{fontSize:'20px'}}>credit_card</span>
                    </div>
                  </div>
            ...
            <div className="flex justify-between items-center mt-6 pt-6 border-t border-slate/10">
              ...
              {step === 'confirm' ? (
                <button onClick={placeOrder} disabled={loading} className="btn-primary py-2.5 px-6">
                  {loading ? (
